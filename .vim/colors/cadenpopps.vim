...
hi Normal guifg=#fccfc6 guibg=#141523 guisp=#141523 gui=NONE ctermfg=224
...
hi IncSearch guifg=#303030 guibg=#cd8b60 guisp=#cd8b60 gui=NONE
...
hi Title guifg=#bebeef guibg=NONE guisp=NONE gui=NONE ctermfg=189 ctermbg=NONE cterm=NONE
...
hi Conditional guifg=#fccfc6 guibg=NONE guisp=NONE gui=NONE ctermfg=224 ctermbg=NONE cterm=NONE
...
hi Special guifg=#8686cb guibg=NONE guisp=NONE gui=NONE ctermfg=104 ctermbg=NONE cterm=NONE
hi LineNr guifg=#8b8bcd guibg=#141523 guisp=#141523 gui=NONE ctermfg=104 ctermbg=NONE cterm=NONE
...
hi Search guifg=#303030 guibg=#cd8b60 guisp=#cd8b60 gui=NONE ctermfg=NONE ctermbg=60 term=NONE
hi Delimiter guifg=#c080d0 guibg=NONE guisp=NONE gui=NONE ctermfg=176 ctermbg=NONE cterm=NONE
hi Statement guifg=#bebeef guibg=NONE guisp=NONE gui=NONE ctermfg=189 ctermbg=NONE cterm=NONE
hi Comment guifg=#616178 guibg=NONE guisp=NONE gui=NONE ctermfg=60 ctermbg=NONE cterm=NONE
...
hi Type guifg=#db8876 guibg=NONE guisp=NONE gui=NONE ctermfg=174 ctermbg=NONE cterm=NONE
hi DiffChange guifg=#ffffcd guibg=#306b8f guisp=#306b8f gui=NONE ctermfg=230 ctermbg=24 cterm=NONE
hi Cursor guifg=#404040 guibg=#8b8bff guisp=#8b8bff gui=NONE ctermfg=238 ctermbg=1 cterm=NONE
...
hi String guifg=#bebeef guibg=NONE guisp=NONE gui=NONE ctermfg=189 ctermbg=NONE cterm=NONE

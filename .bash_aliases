...
alias code='codeopen'
alias workmode='sudo mv /etc/hosts /etc/hosts.norm;sudo mv /etc/hosts.work /etc/hosts'
alias normalmode='sudo mv /etc/hosts /etc/hosts.work;sudo mv /etc/hosts.norm /etc/hosts'
